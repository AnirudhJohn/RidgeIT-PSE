...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ZPA Private Service Edge Deployments Automation</title>
    <style>
        body {
            font-family: Arial, sans-serif;
            background-color: #f4f6f9;
...
<body>
    ...
    <h1>ZPA Private Service Edge Deployments Automation</h1>
    <div class="instructions">
        <h2>Instructions:</h2>
        <p><strong>Step 1:</strong> Add the provisioning key from the ZPA Admin portal and enter it in the text area below.</p>
        <p><strong>Step 2:</strong> Run the generated commands on the Private Service Edge to provision the new connector.</p>
    </div>
...
gpgkey=https://yum.private.zscaler.com/yum/el9/gpg"
    ...
    echo "********************************************************"
    echo "*                                                      *"
    echo "*         Provisioning ZPA Service Edge                *"
    echo "*                                                      *"
    echo "********************************************************"
    echo 
    ...
    #Installing Zscaler Private Service Edge Process
